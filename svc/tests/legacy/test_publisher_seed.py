...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='G+RSS. Publisher Seeder')
    ...
    while True:
        logger.warning('Invoking registration for all, next poll in {0} seconds'.format(args.period))
        ...
        for n in range(0, len(gid_set)):
            ...
            db.pubsub.broadcast_command(S1.publisher_channel_name('twitter'), S1.msg_register(), gid)
