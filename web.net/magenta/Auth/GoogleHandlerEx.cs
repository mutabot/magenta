...
{
    public class GoogleHandlerEx : OAuthHandler<GoogleOptionsEx>
    {
        protected string GetRedirectUri(string redirectUri)
        {
            return Options.CallbackUri != null ? Options.CallbackUri.ToString() : redirectUri;
        }
        ...
        {
            return base.ExchangeCodeAsync(code, GetRedirectUri(redirectUri));
        }
        ...
        protected override string BuildChallengeUrl(AuthenticationProperties properties, string redirectUri)
        {
            ...
            queryStrings.Add("redirect_uri", GetRedirectUri(redirectUri));
